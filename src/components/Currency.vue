...
export default {
   ...
   methods: {
    ...
    currencyChange(){
      this.$emit("currencyChange", this.convertfrom);
    }
  }
}
</script>
...
<template>
      <div id = "databinding" style = "">
         ...
         <input type = "number" v-model.number = "amount" placeholder = {{amount}} @change = "amountChange"/><br/><br/>
         <span>Convert From:</span>
         <select v-model = "convertfrom" style = "width:150px;font-size:15px" @change = "currencyChange" >
